...
class MainView:
    ...
    @staticmethod
    def show_menu(
        menu_function: Callable, menu_name: str,
        options_menu: list, first_display: bool
    ):
        """
        Affiche le menu principal formaté.
        ...
        decoration = helpers.decorative_menu_element(
             function=menu_function, first_display=first_display
        )
